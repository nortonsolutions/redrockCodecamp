...
suite('Functional Tests', function() {
    ...
    suite('PUT /travellers', function(){
      ...
      test('send {surname: "Colombo"}',  function(done){
       ...
       chai.request(server)
        ...
        .end(function(err, res){
          ...
          assert.equal(res.body.surname, 'Colombo', 'res.body.surname name should be "Colombo"');
      ...
      test('send {surname: "da Verrazzano"}', function(done) {
        ...
        .end((req,res) => {
          ...
          assert.equal(res.type, 'application/json', 'Should be JSON');
  ...
  Browser.site = 'http://192.168.109.2:3000'; 
