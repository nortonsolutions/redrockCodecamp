...
class HonestyPolicy extends Component {

  render() {
    return (
      <div>
        <p>
          Before we issue our verified certification to a student, he or she must
        ...
        <p>
          ...
          along with another student with whom I was pair programming in real
          time."
        </p>
        <p>
          "I pledge that I did not plagiarize any of my work. I understand that 
          the development and training staff will audit my projects to confirm this."
        </p>
        <p>
          In the situations where we discover instances of unambiguous plagiarism,
          we will replace the student in question’s certification with a message
        ...
        <p>
          ...
          this policy, or suspect that someone has violated it, please let the
          KCJAE staff or a tutor know and we will investigate.
        </p>
      </div>
    );
  }
